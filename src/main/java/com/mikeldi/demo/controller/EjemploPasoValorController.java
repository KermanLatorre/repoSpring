...
public class EjemploPasoValorController {
	...
	@GetMapping("/ejemplo1")
	public String funcion(Model model) {
		//El model sirve para guardar y recuperar datos de la navegacion
		model.addAttribute("persona", "pepe");
		//Devuelvo la vista a la que quiero acceder, que sera ejemplopasovalor.html
